  ...
  <div className="header">
    ...
    <header className='Header'>
        <h2 className="name" >
            ...
            <div className="icon">
                <div className="icon-img" ref={iconRef} onClick={()=>{openNav()}}> 
        ...
        <nav className="navigation" ref={navRef}>
          <div className="close-icon" ref={closeIconRef} onClick={()=>{closeNav()}}>
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
            ...
            <div className="darkIcon"  onClick={()=>{changeColor()}}>
                           <svg xmlns="http://www.w3.org/2000/svg" className='dark' width="20" height="20" fill="black" class="bi bi-moon-fill" viewBox="0 0 16 16">
